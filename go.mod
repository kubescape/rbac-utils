module github.com/kubescape/rbac-utils
...
require (
	...
	github.com/kubescape/opa-utils v0.0.168
	k8s.io/api v0.23.4
...
require (
	...
	github.com/armosec/armoapi-go v0.0.96 // indirect
	github.com/armosec/utils-go v0.0.9 // indirect
